report 54104 "Fixed Asset Book Value"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/FixedAssetBookValue.rdl';
    ApplicationArea = FixedAssets;
    Caption = 'Envanter Defteri - Sabit Kıymet';
    ...
    dataset
    {
        dataitem("Fixed Asset"; "Fixed Asset")
        {
            ...
            column(BVStartingDate; BookValueAtStartingDate) //added
            {
            }
            ...
            column(BVEndingDate; BookValueAtEndingDate) //added
            {
